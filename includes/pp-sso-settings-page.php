		...
		return array(
			'login_settings' => array(
				...
				array(
					...
					'properties' => array(
						'Login Button' => '[privacy_portal_login_button]',
						'Login URL' => '[privacy_portal_sso_url]',
					),
				),
				array(
			...
			'enroll_settings' => array(
				...
				array(
					...
					'properties' => array(
						...
						'Subscribe URL' => '[privacy_portal_sso_url type="enroll"]',
					),
				),
				array(
					...
					'properties' => array(
						'html' => esc_html( '<div><a href="[privacy_portal_anonymous_subscribe_url]">Subscribe Anonymously</a><p class="hide-when-empty">[privacy_portal_anonymous_subscribe_message]</p></div>' ),
	...
	private function get_settings_fields() {
		...
		$fields = array(
			...
			'scope_enroll'      => array(
				...
				'type'        => 'text',
				'disabled'    => defined( 'OIDC_CLIENT_SCOPE_ENROLL' ),
				'section'     => 'enroll_settings',
			),
			...
			'endpoint_token'    => array(
				'title'       => __( 'Token Validation Endpoint URL', 'privacy-portal-sso' ),
			...
			'no_sslverify'      => array(
				...
				'type'        => 'checkbox',
				'disabled'    => defined( 'OIDC_NO_SSL_VERIFY' ),
				'section'     => 'common_settings',
			),
			'http_request_timeout'      => array(
				...
				'example'     => 30,
				'type'        => 'text',
				'disabled'    => defined( 'OIDC_HTTP_REQUEST_TIMEOUT' ),
				'section'     => 'common_settings',
			),
			...
			'nickname_key'     => array(
				...
				'example'     => 'preferred_username',
				'type'        => 'text',
				'disabled'    => defined( 'OIDC_NICKNAME_KEY' ),
				'section'     => 'common_settings',
				'depends_on'  => 'enable_login',
			),
			'email_format'     => array(
				...
				'example'     => '{email}',
				'type'        => 'text',
				'disabled'    => defined( 'OIDC_EMAIL_FORMAT' ),
				'section'     => 'common_settings',
				'depends_on'  => 'enable_login',
			),
			'displayname_format'     => array(
				...
				'type'        => 'text',
				'disabled'    => defined( 'OIDC_DISPLAY_NAME_FORMAT' ),
				'section'     => 'common_settings',
				'depends_on'  => 'enable_login',
			),
			...
			'state_time_limit'     => array(
				...
				'type'        => 'number',
				'disabled'    => defined( 'OIDC_STATE_TIME_LIMIT' ),
				'section'     => 'common_settings',
				'depends_on'  => 'enable_login',
			),
			'token_refresh_enable'   => array(
				...
				'type'        => 'checkbox',
				'disabled'    => defined( 'OIDC_TOKEN_REFRESH_ENABLE' ),
				'section'     => 'common_settings',
				'depends_on'  => 'enable_login',
			),
